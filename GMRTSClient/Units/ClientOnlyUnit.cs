...
namespace GMRTSClient.Units
{
    ...
    {
        public ClientOnlyUnit(Texture2D texture, Texture2D selectionTexture, Vector2 position, float rotation, float scale)
            : base(Guid.Empty, texture, selectionTexture)
        {
            ...
            Rotation = new GMRTSClasses.Changing<float>(0, 0, null, 0);
        }
