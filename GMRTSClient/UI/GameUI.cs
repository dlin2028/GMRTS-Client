...
namespace GMRTSClient.UI
{
	...
	public partial class GameUI
	{
		...
		public Changing<float> Minerals { get; set; }
		public Changing<float> Gold { get; set; }
		...
		public GameUI()
		{
			...
			Minerals = new Changing<float>(0, 0, FloatChanger.FChanger, 0);
			Gold = new Changing<float>(0, 0, FloatChanger.FChanger, 0);
			...
			BuildMarketButton.Click += (s, a) => { CurrentBuilding = BuildingType.Supermarket; };
        ...
        {
			Minerals.Update(currentMillis);
			Gold.Update(currentMillis);

			GoldLabel.Text = "Gold: " + Gold.Value;
			MineralLabel.Text = "Minerals: " + Minerals.Value;
        }
